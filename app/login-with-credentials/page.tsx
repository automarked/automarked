...
const LoginWithCredentials = () => {
  ...
  const handleLogin = useCallback(async () => {
    ...
    if (result === "seller" || result === "collaborator") {
      showToast("Neste momento um vendedor não pode fazer login na plataforma.", "")
    }
  ...
  return (
    <div className="flex flex-col bg-white py-4 items-center justify-center min-h-screen">
      <div className="flex flex-col items-center justify-center h-full px-6 bg-white">
        ...
        <div className="flex items-center w-full max-w-md mb-6">
          ...
          <Link href={"/forgot-password"} className="mx-3 text-black font-semibold underline">Esqueceu a senha?</Link>
          <hr className="flex-1 border-gray-300" />
        </div>
